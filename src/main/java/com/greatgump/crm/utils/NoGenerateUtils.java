...
public class NoGenerateUtils {
  ...
  private static final String COST_CODE = "FY";
  /**
   * 回款类别头
   */

  private static final String BACK_MONEY = "HK";
   ...
   * @param userId 网站中该用户唯一ID 防止重复
   */
  public static String getCostCode(Integer userId) {
    return COST_CODE + getCode(userId);
  }
   ...
   * @param userId  网站中该用户唯一ID 防止重复
   */
  public static String getBackMoneyCode(Integer userId) {
    return BACK_MONEY + getCode(userId);
  }
